export const questions = [
  {
    question:
      "Which of the following is an example of a scenario-oriented acceptance criteria?",
    translation: {
      vi: "Điều nào sau đây là một ví dụ về tiêu chí chấp nhận (acceptance criteria) định hướng theo kịch bản (scenario-oriented)?",
    },
    answers: [
      {
        text: "The user can provide three inputs for product testing—the AI model to be tested, the data used, and an optional text file.",
        correct: false,
        translation: {
          vi: "Người dùng có thể cung cấp ba đầu vào để kiểm thử sản phẩm - mô hình AI cần kiểm thử, dữ liệu được sử dụng và một tệp văn bản tùy chọn",
        },
      },
      {
        text: "Unregistered users are not shown any reports.",
        correct: false,
        translation: {
          vi: "Người dùng chưa đăng ký không được hiển thị bất kỳ báo cáo nào.",
        },
      },
      {
        text: "Verify that a registered user can create one more new project with a name over 100 characters.",
        correct: false,
        translation: {
          vi: "Xác minh rằng người dùng đã đăng ký có thể tạo thêm một dự án mới với tên có hơn 100 ký tự.",
        },
      },
      {
        text: "A logged-in user, upon navigating to the AI model testing page, should be directly shown the report of the most recent test run.",
        correct: true,
        translation: {
          vi: "Một người dùng đã đăng nhập, sau đó khi điều hướng đến trang kiểm thử mô hình AI, người dùng sẽ được hiển thị trực tiếp báo cáo của lần chạy kiểm thử gần nhất.",
        },
      },
    ],
  },
  {
    question:
      'Consider a program that calculates the factorial of a number (n). From the specification, you know that: If n < 0, a "Value out of range" message must be given. If 0 ≤ n ≤ 100, the program calculates the factorial and returns the number. If 100 ≤ n ≤ 200 a "Value out of range" message must be given. Which of the following statements about equivalence partitions is **TRUE**?',
    translation: {
      vi: 'Xem xét một chương trình tính giai thừa của một số (n). Từ đặc tả, bạn biết rằng: Nếu n < 0, một thông báo "Giá trị nằm ngoài phạm vi" phải được đưa ra. Nếu 0 ≤ n ≤ 100, chương trình tính giai thừa và trả về số. Nếu 100 ≤ n ≤ 200 thông báo "Giá trị nằm ngoài phạm vi" phải được đưa ra. Tuyên bố nào sau đây về các phân vùng tương đương (equivalence partitions) là **ĐÚNG**?',
    },
    answers: [
      {
        text: "There are 3 partitions - one for negative numbers, one for numbers up to 100, and the last partition for numbers up to 200.",
        correct: false,
        translation: {
          vi: "Có 3 phân vùng - một cho số âm, một cho số lên đến 100 và phân vùng cuối cùng cho số lên đến 200",
        },
      },
      {
        text: "The requirements are incorrect because the partitions overlap.",
        correct: true,
        translation: {
          vi: "Các yêu cầu không đúng vì các phân vùng bị trùng lặp.",
        },
      },
      {
        text: "Equivalence partitions cannot be defined for this question because the error messages for the two partitions are exactly the same.",
        correct: false,
        translation: {
          vi: "Không thể xác định các phân vùng tương đương cho câu hỏi này vì thông báo lỗi cho hai phân vùng hoàn toàn giống nhau",
        },
      },
      {
        text: "Equivalence partitions cannot be defined for this question because the factorial of numbers near 200 will be very large.",
        correct: false,
        translation: {
          vi: "Không thể xác định các phân vùng tương đương cho câu hỏi này vì giai thừa của các số gần 200 sẽ rất lớn",
        },
      },
    ],
  },
  {
    question:
      "Which of the following is a good testing practice that applies **INDEPENDENTLY** of the software development lifecycle followed?",
    translation: {
      vi: "Điều nào sau đây là một thực hành kiểm thử tốt áp dụng **ĐỘC LẬP** với vòng đời phát triển phần mềm được tuân theo?",
    },
    answers: [
      {
        text: "Not all development activities must have corresponding testing activities.",
        correct: false,
        translation: {
          vi: "Không phải tất cả các hoạt động phát triển đều phải có các hoạt động kiểm thử tương ứng",
        },
      },
      {
        text: "Large redundancy between testing levels is good because it prevents defects from leaking.",
        correct: false,
        translation: {
          vi: "Lượng dư thừa lớn giữa các cấp độ kiểm thử là tốt vì nó ngăn chặn lỗi bị rò rỉ",
        },
      },
      {
        text: "Reviews should be performed after work products are finalized.",
        correct: false,
        translation: {
          vi: "Các cuộc rà soát (reviews) nên được thực hiện sau khi các sản phẩm công việc đã được hoàn thiện",
        },
      },
      {
        text: "Each test level should have an appropriate test objective.",
        correct: true,
        translation: {
          vi: "Mỗi cấp độ kiểm thử nên có một mục tiêu kiểm thử phù hợp",
        },
      },
    ],
  },
  {
    question:
      "Which of the following **TRUE** statements is an example of the purpose of a test plan?",
    translation: {
      vi: "Điều **ĐÚNG** nào sau đây là một ví dụ về mục đích của một kế hoạch kiểm thử?",
    },
    answers: [
      {
        text: "A test manager decides to create a one-page test plan for an agile project to communicate general activities and explain why detailed test cases will not be written as dictated by testing policy.",
        correct: true,
        translation: {
          vi: "Một người quản lý kiểm thử quyết định tạo một kế hoạch kiểm thử một trang cho một dự án agile để truyền đạt các hoạt động chung và giải thích lý do tại sao các trường hợp kiểm thử chi tiết sẽ không được viết theo quy định của chính sách kiểm thử.",
        },
      },
      {
        text: "A test plan is a good document for agile projects because it helps the test manager assign tasks to different people.",
        correct: false,
        translation: {
          vi: "Kế hoạch kiểm thử là một tài liệu tốt cho các dự án agile vì nó giúp người quản lý kiểm thử giao nhiệm vụ cho những người khác nhau.",
        },
      },
      {
        text: "A test lead decides to write a detailed test plan so that in the future, if the project fails, responsibility can be assigned to the right person.",
        correct: false,
        translation: {
          vi: "Một trưởng nhóm kiểm thử quyết định viết một kế hoạch kiểm thử chi tiết để trong tương lai, nếu dự án thất bại, trách nhiệm có thể được giao cho đúng người.",
        },
      },
      {
        text: "A test manager must always create a very simple test plan because the purpose of the test plan is to ensure documentation for auditing purposes.",
        correct: false,
        translation: {
          vi: "Một người quản lý kiểm thử phải luôn tạo một kế hoạch kiểm thử rất đơn giản vì mục đích của kế hoạch kiểm thử là để đảm bảo có tài liệu cho mục đích kiểm toán.",
        },
      },
    ],
  },
  {
    question:
      "A software development company invests heavily in tools to support the entire software development lifecycle, including testing. They have a tool that allows for automated creation and installation of builds and then executes various types of automated testing. Which of the following **TRUE** statements about this type of testing tool?",
    translation: {
      vi: "Một công ty phát triển phần mềm đầu tư lớn vào các công cụ để hỗ trợ toàn bộ vòng đời phát triển phần mềm, bao gồm cả kiểm thử. Họ có một công cụ cho phép tự động tạo và cài đặt các bản dựng (builds) và sau đó thực hiện các loại kiểm thử tự động khác nhau. Tuyên bố **ĐÚNG** nào sau đây về loại công cụ kiểm thử này?",
    },
    answers: [
      {
        text: "It is an example of DevOps-related tools.",
        correct: true,
        translation: {
          vi: "Đó là một ví dụ về các công cụ liên quan đến DevOps.",
        },
      },
      {
        text: "It is an example of a collaboration tool.",
        correct: false,
        translation: {
          vi: "Đó là một ví dụ về công cụ cộng tác (collaboration tool).",
        },
      },
      {
        text: "It is an example of a test implementation tool.",
        correct: false,
        translation: {
          vi: "Đó là một ví dụ về công cụ triển khai kiểm thử (test implementation tool).",
        },
      },
      {
        text: "It is an example of an automated unit testing tool.",
        correct: false,
        translation: {
          vi: "Đó là một ví dụ về công cụ kiểm thử đơn vị tự động (automated unit testing tool).",
        },
      },
    ],
  },
  {
    question:
      "Which of the following describes the difference between an informal review and a technical review?",
    translation: {
      vi: "Điều nào sau đây mô tả sự khác biệt giữa một cuộc rà soát không chính thức (informal review) và một cuộc rà soát kỹ thuật (technical review)?",
    },
    answers: [
      {
        text: "An informal review is led by the author of the work product, while a technical review is led by the quality assurance staff member.",
        correct: false,
        translation: {
          vi: "Một cuộc rà soát không chính thức được dẫn dắt bởi tác giả của sản phẩm công việc, trong khi rà soát kỹ thuật được dẫn dắt bởi nhân viên đảm bảo chất lượng.",
        },
      },
      {
        text: "An informal review is less formal than a technical review, and neither is required to use checklists.",
        correct: true,
        translation: {
          vi: "Một cuộc rà soát không chính thức ít trang trọng hơn rà soát kỹ thuật, và cả hai đều không bắt buộc phải sử dụng danh sách kiểm tra (checklists).",
        },
      },
      {
        text: "An informal review is conducted on a non-technical document, while a technical review is conducted on a technical document.",
        correct: false,
        translation: {
          vi: "Một cuộc rà soát không chính thức được tiến hành trên một tài liệu phi kỹ thuật, trong khi rà soát kỹ thuật được tiến hành trên một tài liệu kỹ thuật.",
        },
      },
      {
        text: "An informal review does not involve any meeting, while a technical review requires a formal review meeting.",
        correct: false,
        translation: {
          vi: "Một cuộc rà soát không chính thức không liên quan đến bất kỳ cuộc họp nào, trong khi rà soát kỹ thuật yêu cầu một cuộc họp rà soát chính thức.",
        },
      },
    ],
  },
  ...
  },
  {
    ...
    translation: {
      vi: "Khi sử dụng kỹ thuật thiết kế kiểm thử phân tích giá trị biên (BVA) cho phạm vi đầu vào hợp lệ từ 1 đến 500, tập hợp các giá trị kiểm thử thích hợp nào sau đây?",
    },
    answers: [
      {
        text: "0, 1, 500, 501",
  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        correct: false,
        translation: {
          vi: "Một loạt các bài kiểm thử trong đó áp suất được đặt thành -1, 0, 175, và 297 pounds",
        },
      },
    ],
  },
